  ...
  const checkSchoolName = () => {
    ...
    if (!registrationForm.schoolName.match(regEx)) {
      return {
        valid: false,
        message:
          'Nom école invalide : seul les caractères alphabétiques sont acceptés.',
      };
    }
    return {
      valid: true,
  ...
  const register = async () => {
    ...
    try {
      ...
      registrationSuccessMessage =
        "Merci pour l'enregistrement, vous serez redirigé au login...";
  ...
  <div class="columns">
    <div class="column">
      <div class="content">
        ...
        <p>
          Nous facilitons la publication de vos menus scolaires hebdomadaires
          sur le web et les fournissons aux élèves et aux parents dans un format
          adapté au mobile.
        </p>
        <p>
          Entrez seulement les détails du menu et pressez publiez !
          Enregistrez-vous et débutez dès aujourd'hui.
        </p>
      </div>
    </div>
    <div class="column">
